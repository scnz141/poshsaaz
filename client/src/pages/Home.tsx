...
const COLLECTIONS = [
  ...
  },
  {
    ...
    description: "Grand double-ring wall hangings with 25+ cascading velvet roses across 5 color palettes, alongside earthy autumn botanical wreaths.",
    image: IMAGES.wall,
    features: ["25+ handmade velvet roses", "Double wrapped hoop frame", "5 curated color palettes", "Heirloom Kashmiri artisan art"],
    badge: "Masterpiece",
    price: "₹850 – ₹1,000",
  ...
  },
  {
    ...
    features: ["Noir velvet daisy chains", "Pearl bead wrist strands", "Skin-safe soft chenille", "Statement occasion jewelry"],
    badge: "New Arrival",
    price: "₹200",
  },
  {
    ...
    description: "Opulent crimson velvet bouquets in gold-crested black wrap, monochromatic pearl daisy arrangements, and everlasting lavender and sunflower bundles.",
    image: IMAGES.bouquets,
    features: ["Crimson velvet & pearl roses", "Monochrome pastel daisy bundles", "Never wilts or fades", "Gift-ready presentation"],
    badge: "Best Seller",
    price: "₹500 – ₹800",
  },
  {
