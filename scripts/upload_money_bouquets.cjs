...
const itemsToUpload = [
  {
    file: 'media_1787920913972.jpg',
    public_id: 'poshsaaz/money_bouquet_white_flower',
    name: 'Royal Note Origami Bouquet with White Bloom'
  },
  {
    file: 'media_1787920920941.jpg',
    public_id: 'poshsaaz/money_bouquet_purple_teal',
    name: 'Bespoke Currency Note Bouquet with Purple Blossom'
  },
  {
    file: 'media_1787920927054.jpg',
    public_id: 'poshsaaz/money_bouquet_purple_mandala',
    name: 'Grand Currency Mandala Bouquet with Purple Flower'
  }
];
...
async function main() {
  console.log('💵 Uploading Money Bouquets to Cloudinary...\n');
  const results = [];
  ...
  fs.writeFileSync('./scripts/uploaded_money_bouquets.json', JSON.stringify(results, null, 2));
}
