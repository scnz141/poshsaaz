...
const itemsToUpload = [
  {
    ...
    public_id: 'poshsaaz/wall_decor_autumn_wreath',
    name: 'Autumn Bloom Botanical Wall Wreath'
  }
];
...
async function main() {
  console.log('🍂 Uploading Wall Wreath (₹850) to Cloudinary...\n');
  const results = [];
  ...
  fs.writeFileSync('./scripts/uploaded_wreath_850.json', JSON.stringify(results, null, 2));
}
